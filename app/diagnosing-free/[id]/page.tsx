    ...
    <main className="min-h-screen paper-bg flex items-center justify-center px-6">
      <div className="max-w-sm w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif text-2xl font-bold text-[#2c2c2c] tracking-wider">八字合局 · 启判中</h1>
          <p className="font-serif text-sm text-[#5a5a5a] mt-2 tracking-wider">{status?.current_step ?? "准备起卦..."}</p>
        </div>
        ...
        <div className="card-paper p-6 shadow-sm">
          <div className="mb-5">
            ...
            <div className="flex justify-between mt-2 font-serif text-xs text-[#8b8b8b]">
              <span>推演进度</span><span>{status?.progress ?? 0}%</span>
            </div>
          </div>
